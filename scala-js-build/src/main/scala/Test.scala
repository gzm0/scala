...
/*  def newScalaJSPlugin(global: Global): ScalaJSPlugin =
  ...
  def testOutputPath = "foo" //sys.props("scala.scalajs.compiler.test.output")
  def scalaJSLibPath = "bar" //sys.props("scala.scalajs.compiler.test.scalajslib")
  def scalaLibPath   = "lala" //sys.props("scala.scalajs.compiler.test.scalalib")
